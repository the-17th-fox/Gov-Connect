...
public class GetAllClassificationsQuery : HandlerBase, IRequestHandler<GetAllClassificationsQuery, List<Classification>>
{
    public GetAllClassificationsQuery(IUnitOfWork unitOfWork) : base(unitOfWork)
    {
    }
